...
const productDetails = async ({params:{id}}: Props) => {
    ...
    const isEqual = product.originalPrice === product.currentPrice;
        ...
        <div className="flex gap-28 xl:flex-row flex-col">
            ...
            <div className="product-info">
                <div className="flex flex-col gap-2">
                    ...
                    { isEqual? <p className="text-sm text-black opacity-50">No Discounts</p> : <p className="text-[21px] text-black opacity-50 line-through">
                ...
                <div className="flex flex-col gap-4">
                    ...
                    <p className="text-sm text-black opacity-50">
                        <span className="text-primary-green font-semibold">
                            91% </span>buyers recommended this
                    </p>
                </div>
            </div>
